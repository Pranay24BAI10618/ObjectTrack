# ObjectTrack — Real-Time Object Detection, Tracking & Video Analytics
...
Repository: https://github.com/Pranay24BAI10618/ObjectTrack

---

## Overview

ObjectTrack watches a video (a file or a live webcam), and for every frame:
...
```bash
git clone https://github.com/Pranay24BAI10618/ObjectTrack.git
cd ObjectTrack
```
...
| `logs/objecttrack.log` | Full run log |
